<div class="fixed w-full z-50">
    <div class="container">
        <div class="flex flex-wrap justify-between items-center py-12 text-white">
            <div class="w-fit">
                <a href="./">
                    <img src="<?= get_template_directory_uri() ?>/images/logo/logo.png" alt="Fix N Flow">
                </a>
            </div>
            <div class="w-fit">
                <div class="flex flex-wrap items-center -mx-4">
                    <div class="w-fit px-4">
                        <a href="/about-us" class="font-articulat font-semibold text-base">About us</a>
                    </div>
                    <div class="w-fit px-4">
                        <a href="/contact-us" class="font-articulat font-semibold text-base">Contact us</a>
                    </div>
                    <div class="w-fit px-4">
                        <a href="/contact-us" class="font-articulat font-semibold text-base flex items-center justify-center gap-x-3 border border-yellow rounded-md h-[41px] px-3.5">
                            See all services
            ...
            <div class="w-fit bg-yellow rounded-[10px] p-1.5">
                <div class="flex flex-wrap items-center -mx-4">
