<div class="partContact bg-light-blue xl:bg-[#D3E2EF] relative overflow-hidden group">
    <img src="<?= get_template_directory_uri() ?>/images/background/homepageContact-component.png" alt="fixnflow" class="absolute top-0 left-0 group-hover:-top-[50%] duration-1000 hidden lg:block">
