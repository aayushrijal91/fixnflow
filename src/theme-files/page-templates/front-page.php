...
<div class="homePage">
    ...
    <div class="py-28 bg-no-repeat bg-contain" style="background-image: url('<?= get_template_directory_uri() ?>/images/background/homepage_services.png')">
        <div class="container py-20">
            ...
            <div class="bg-light rounded-[35px] py-16 mt-16">
    ...
    <div class="bg-dark-blue pt-40 pb-14 bg-no-repeat" style="background-image:url(<?= get_template_directory_uri() ?>/images/background/homepage_guarantee_vector.png)">
        <div class="container">
            <div class="flex flex-wrap justify-between">
                <div class="w-full lg:w-5/12">
                    <div class="text-white text-[65px] font-bold leading-none pb-12">What you're <span class="text-light-blue">guaranteed</span> to get from us</div>
                        ...
                        <div class="w-full md:w-1/3 px-2 group">
                            <div class="relative bg-white h-full w-full rounded-2xl py-4 px-8 transition-all duration-300 group-hover:-translate-x-2 hover:-translate-y-2 group-hover:shadow-[10px_10px_#0067B9] overflow-hidden">
                                ...
                                <div class="flex flex-col items-center gap-y-4 relative h-full">
                                    ...
                                    <div class="flex justify-center">
                                        <div class="text-[65px] leading-none font-bold text-light-blue group-hover:text-dark-blue transition-all duration-150 border-b border-light-blue pb-3">
                                            01
                                        </div>
                                    </div>
    ...
    <div class="relative group">
        ...
        <!-- <img src="<?= get_template_directory_uri() ?>/images/lib/homepage_why_us_vector_1.png" alt="" class="w-full opacity-100 group-hover:opacity-0 duration-300 absolute top-0"> -->
        <!-- </div> -->
        <div class="bg-white group-hover:bg-secondary-blue duration-500 pb-40">
            <div class="container">
                <div class="flex flex-wrap justify-between items-center">
                    <div class="text-[65px] font-bold text-main-blue group-hover:text-white duration-500">Why Choose Fix N Flow?</div>
