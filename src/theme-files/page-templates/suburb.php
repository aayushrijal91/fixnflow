...
<div class="suburbPage bg-off-white">
        ...
        <div class="generalBanner max-w-[1874px] mx-auto h-[576px] rounded-[30px] overflow-hidden">
            <div class="container">
                <div class="pt-48 pb-12 text-white text-center">
                    <div class="text-4xl md:text-5xl xl:text-heading font-bold">Servicing <?= get_the_title() ?></div>
    ...
    <div class="container ">
        ...
        <div class="flex flex-wrap py-28">
            <div class="w-1/3">
                <div class="text-4xl md:text-5xl xl:text-heading text-main-blue font-bold">Lorem ipsum dolor sit amet, consectetur</div>
                <div class="pt-10">
            ...
            <div class="w-2/3">
                <div class="bg-white hover:bg-quaternary duration-300 rounded-[30px] h-full py-10 px-14 font-articulat text-grey hover:text-primary leading-relaxed description columns-2">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                </div>
            </div>
    ...
    <div class="bg-main-blue pt-24 text-white">
        <div class="container">
            <div class="flex flex-wrap justify-between">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="text-[35px] font-bold leading-none">Sagittis nisl rhoncus mattis rhoncus urna neque viverra justo nec.</div>
                    <div class="description font-articulat leading-loose pt-11">
    ...
    <div class="container">
        <div class="flex flex-wrap py-24">
            ...
            <div class="w-2/3">
                <div class="bg-main-blue rounded-[30px] h-full py-10 px-14 font-articulat text-white leading-relaxed description columns-2">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                </div>
            </div>
