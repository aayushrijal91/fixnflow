...
<main class="bg-off-white">
    <div class="aboutBanner max-w-[1874px] mx-auto p-1 xl:p-6">
        <div class="flex flex-wrap -mx-2 gap-y-2">
                    ...
                    <div class="xl:w-10/12 ml-auto px-5 pt-24 md:pt-48 pb-20 md:pb-24 relative text-center xl:text-start">
                        <?php if (isset($banner)) : ?>
                            ...
                            <?php if ($banner['subtitle']) : ?>
                                <p class="pt-6 text-lg font-articulat text-white">
                                    <?= $banner['subtitle'] ?>
                                </p>
                        <?php
                            endif;
            ...
            <div class="w-full xl:w-5/12 px-2 order-1 xl:order-2">
                <div class="relative rounded-[20px] md:rounded-[30px] min-h-[272px] md:min-h-[400px] bg-light-blue h-full overflow-hidden group flex justify-center" style="background:url(<?= $banner['image']['url'] ?>) no-repeat center; background-size: cover">
    ...
    <div class="aboutPage">
        ...
        <div class="pt-10 pb-24 md:pb-44">
            <h2 class="text-center text-4xl md:text-5xl xl:text-heading text-main-blue font-bold pb-16 lg:pb-28">Meet our expert plumbers</h2>
                ...
                ?>
                            ...
                            <?php if ($member_1['name']) : ?>
                                <div class="min-h-[405px] h-full rounded-[20px] overflow-hidden flex items-end" style="background:url(<?= $member_1['image']['url'] ?>); background-size:cover; background-position: center;">
                                    <div class="w-full bg-gradient-to-b from-transparent to-black bottom-0 p-5">
                                        <p class="text-2xl text-light-blue font-bold pb-6">Work with <?= $member_1['name'] ?></p>
                                        <div class="flex flex-wrap gap-y-1 text-white">
                                            <p class="w-full"><?= $member_1['linkedin_link'] ?></p>
                                            <p class="w-full"><?= $member_1['phone_number'] ?></p>
                                            <p class="w-full"><?= $member_1['facebook_link'] ?></p>
                                            <p class="w-full"><?= $member_1['email'] ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($member_1['name']) : ?>
                                <div class="rounded-[20px] overflow-hidden bg-[#D3E2EF] w-full py-5 px-4 aboutDescriptionWrapper">
                                    <div class="flex flex-wrap justify-between items-center">
                                        <h4 class="text-4xl font-bold text-main-blue"><?= $member_1['name'] ?></h4>
                                        <img src="<?= get_template_directory_uri() ?>/images/logo/small-logo.png" alt="<?php bloginfo('name'); ?>">
                                    </div>
                                    <article class="bg-white rounded-[10px] py-3.5 px-4 text-2xl text-grey font-bold flex gap-x-3 items-center my-8">
                                        <?= echo_image($member_1['icon']) ?>
                                        <?= $member_1['position'] ?>
                                    </article>
                                    <article class="text-dark-blue font-articulat leading-relaxed description hidden"><?= $member_1['about'] ?></article>
                            ...
                            <?php if ($member_2['name']) : ?>
                                <div class="min-h-[405px] h-full rounded-[20px] overflow-hidden flex items-end bg-center" style="background: url(<?= $member_2['image']['url'] ?>); background-size: cover; background-position: center;">
                                    <div class="w-full bg-gradient-to-b from-transparent to-black p-5">
                                        <p class="text-2xl text-light-blue font-bold pb-6">Work with <?= $member_2['name'] ?></p>
                                        <div class="flex flex-wrap gap-y-1 text-white">
                                            <p class="w-full"><?= $member_2['linkedin_link'] ?></p>
                                            <p class="w-full"><?= $member_2['phone_number'] ?></p>
                                            <p class="w-full"><?= $member_2['facebook_link'] ?></p>
                                            <p class="w-full"><?= $member_2['email'] ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="w-full md:w-1/2 px-2">
                            <?php if ($member_2['name']) : ?>
                                <div class="rounded-[20px] overflow-hidden bg-[#D3E2EF] w-full py-5 px-4 aboutDescriptionWrapper">
                                    <div class="flex flex-wrap justify-between items-center">
                                        <h4 class="text-4xl font-bold text-main-blue"><?= $member_2['name'] ?></h4>
                                        <img src="<?= get_template_directory_uri() ?>/images/logo/small-logo.png" alt="<?php bloginfo('name'); ?>">
                                    </div>
                                    <article class="bg-white rounded-[10px] py-3.5 px-4 text-2xl text-grey font-bold flex gap-x-3 items-center my-8">
                                    ...
                                    <article class="text-dark-blue font-articulat leading-relaxed description hidden"><?= $member_2['about'] ?></article>
            ...
            <div class="hidden xl:block">
                ...
                ?>
                        <div class="relative mt-5">
                            <img id="gotoTeam<?= $key ?>_1" class="absolute top-[45%] z-[10000] cursor-pointer left-[20%]" src="<?= get_template_directory_uri() ?>/images/icons/arrow-prev.png" alt="<?php bloginfo('name'); ?>">
                            <img id="gotoTeam<?= $key ?>_4" class="absolute top-[45%] z-[10000] cursor-pointer right-[20%]" src="<?= get_template_directory_uri() ?>/images/icons/arrow-next.png" alt="<?php bloginfo('name'); ?>">
                            ...
                            <div class="team_slider" id="team_slider_<?= $key ?>">
                                <div class="team_card_1 px-2">
                                    <?php if ($member_1['name']) : ?>
                                        <div class="min-h-[607px] h-full rounded-[30px] overflow-hidden bg-[#D3E2EF] w-full py-11 px-14">
                                            <div class="flex flex-wrap justify-between items-center">
                                                <h4 class="text-4xl md:text-5xl xl:text-heading font-bold text-main-blue"><?= $member_1['name'] ?></h4>
                                                <img src="<?= get_template_directory_uri() ?>/images/logo/small-logo.png" alt="<?php bloginfo('name'); ?>">
                                            </div>
                                            <article class="bg-white rounded-[10px] py-3.5 px-4 text-2xl text-grey font-bold flex gap-x-3 items-center my-8">
                                                <?= echo_image($member_1['icon']) ?>
                                            ...
                                            <article class="text-dark-blue font-articulat leading-relaxed description"><?= $member_1['about'] ?></article>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <div class="min-h-[607px] h-full rounded-[30px] overflow-hidden group relative">
                                            ...
                                            <div class="absolute w-full bg-gradient-to-b from-transparent to-black -bottom-56 group-hover:bottom-0 duration-300 p-12">
                                                ...
                                                <div class="flex flex-wrap -mx-2 gap-y-4 text-white">
                                                    <p class="w-1/2 px-2"><?= $member_1['linkedin_link'] ?></p>
                                                    <p class="w-1/2 px-2"><?= $member_1['phone_number'] ?></p>
                                                    <p class="w-1/2 px-2"><?= $member_1['facebook_link'] ?></p>
                                                    <p class="w-1/2 px-2"><?= $member_1['email'] ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <div class="team_card_3 px-2">
                                    <?php if ($member_2['name']) : ?>
                                        <div class="min-h-[607px] h-full rounded-[30px] overflow-hidden group relative">
                                            ...
                                            <div class="absolute w-full bg-gradient-to-b from-transparent to-black -bottom-56 group-hover:bottom-0 duration-300 p-12">
                                                <h4 class="text-2xl text-light-blue font-bold pb-6">Work with <?= $member_2['name'] ?></h4>
                                                <div class="flex flex-wrap -mx-2 gap-y-4 text-white">
                                                    <p class="w-1/2 px-2"><?= $member_2['linkedin_link'] ?></p>
                                                    <p class="w-1/2 px-2"><?= $member_2['phone_number'] ?></p>
                                                    <p class="w-1/2 px-2"><?= $member_2['facebook_link'] ?></p>
                                                    <p class="w-1/2 px-2"><?= $member_2['email'] ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <div class="team_card_4 px-2">
                                    <?php if ($member_2['name']) : ?>
                                        ...
                                        <div class="min-h-[607px] h-full rounded-[30px] overflow-hidden bg-[#D3E2EF] w-full py-11 px-14">
                                            <div class="flex flex-wrap justify-between items-center">
                                                <h4 class="text-4xl md:text-5xl xl:text-heading font-bold text-main-blue"><?= $member_2['name'] ?></h4>
                                                <img src="<?= get_template_directory_uri() ?>/images/logo/small-logo.png" alt="<?php bloginfo('name'); ?>">
                                            </div>
                                            <article class="bg-white rounded-[10px] py-3.5 px-4 text-2xl text-grey font-bold flex gap-x-3 items-center my-8">
                                                <?= echo_image($member_2['icon']) ?>
                                            ...
                                            <article class="text-dark-blue font-articulat leading-relaxed description"><?= $member_2['about'] ?></article>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
