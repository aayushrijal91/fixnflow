...
<div class="blogsPage bg-off-white">
    ...
    <div class="p-6">
        <div class="section_1 max-w-[1874px] mx-auto pt-6 pb-11 px-10 rounded-[30px] overflow-hidden relative">
            <?= echo_theme_image('/images/background/bannerWaves.png', 'absolute w-full top-0 left-0') ?>
            ...
            <div class="relative">
                <div class="flex flex-wrap gap-x-10">
                    ...
                    <div class="w-fit">
                        <div class="flex flex-wrap items-center gap-x-3">
                            <div class="w-fit text-light-blue font-articulat font-semibold px-10">15 June 2023</div>
                ...
                <div class="flex flex-wrap flex-col items-center text-center gap-y-10">
                    ...
                    <div class="w-full lg:w-6/12 text-[45px] text-white font-semibold leading-none">
                        Latest blog amet, consectetur adipiscing elit consectetur adipiscing elit
                    </div>
                    <div class="w-full lg:w-7/12 text-white font-articulat">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vitae aliquet nec ullamcorper sit amet risus nullam eget. Elit eget gravida cum sociis natoque...
                    </div>
                    <div class="w-fit"><a href="" class="btn-main-blue-hover-yellow px-14"><span class="relative z-10">Button name here</span></a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-24">
        ...
        <div id="most_popular_blogs" class="blogs_list pt-16">
            <div class="container">
                <div class="flex flex-wrap justify-between items-center pb-8">
                    <div class="w-full md:w-1/2 font-articulat text-dark font-bold text-2xl">Most popular</div>
                    <div class="w-fit flex flex-wrap gap-x-12">
        ...
        <div id="latest_news_blogs" class="blogs_list pt-16">
            <div class="container">
                <div class="flex flex-wrap justify-between items-center pb-8">
                    <div class="w-full md:w-1/2 font-articulat text-dark font-bold text-2xl">Latest news</div>
                    <div class="w-fit flex flex-wrap gap-x-12">
        ...
        <div id="emergency_plumbing_blogs" class="blogs_list pt-16">
            <div class="container">
                <div class="flex flex-wrap justify-between items-center pb-8">
                    <div class="w-full md:w-1/2 font-articulat text-dark font-bold text-2xl">Emergency Plumbing</div>
                    <div class="w-fit flex flex-wrap gap-x-12">
                        <a href="javascript:void(0)" class="blog_prev">
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="36" viewBox="0 0 34 36" fill="none">
                                <path d="M4.78432 19.4884C4.19853 18.9026 4.19853 17.9529 4.78432 17.3671L14.3303 7.82113C14.916 7.23535 15.8658 7.23535 16.4516 7.82113C17.0374 8.40692 17.0374 9.35667 16.4516 9.94245L7.9663 18.4277L16.4516 26.913C17.0374 27.4988 17.0374 28.4485 16.4516 29.0343C15.8658 29.6201 14.916 29.6201 14.3303 29.0343L4.78432 19.4884ZM28.1543 19.9277H5.84498V16.9277H28.1543V19.9277Z" fill="#22346C" />
    ...
    <div class="container pt-24 pb-60">
        <div class="w-full lg:w-8/12 mx-auto">
            <div class="text-center text-main-blue text-heading font-bold">Most common questions</div>
