...
<div class="faqPage bg-off-white">
            ...
            <div class="flex flex-wrap -mx-3 gap-y-5">
                <div class="w-full xl:w-1/2 px-3">
                    <div class="partGlobalCta md:h-[402px] rounded-xl md:rounded-[30px] bg-gradient-to-b from-[#316A9E] to-[#153B74] flex px-5 md:px-20 pt-60 pb-10 md:py-11 relative overflow-hidden">
                        ...
                        <div class="relative text-center">
                            <h2 class="text-3xl md:text-4xl lg:text-[45px] font-bold text-light-blue highlight-white"><?= $cta_1['heading'] ?></h2>
                            <p class="text-white font-articulat py-7"><?= $cta_1['sub_heading'] ?></p>
                            <?php if ($cta_1['button']) : ?>
                ...
                <div class="w-full xl:w-1/2 px-3">
                    <div class="partGlobalCta md:h-[402px] rounded-xl md:rounded-[30px] px-10 md:px-20 py-11 bg-no-repeat bg-cover relative overflow-hidden" style="background:url(<?= get_template_directory_uri() ?>/images/background/faq_cta_2.jpg) no-repeat; background-size: cover">
                        ...
                        <div class="relative text-center">
                            <h2 class="text-4xl lg:text-[45px] font-bold text-dark-blue highlight-white pb-60 md:pb-7"><?= $cta_2['heading'] ?></h2>
                            <?php if ($cta_2['button']) : ?>
    ...
    <div class="container pb-24">
        <div class="w-full lg:w-8/12 mx-auto">
            <h2 class="text-center text-grey text-4xl md:text-5xl xl:text-heading font-bold highlight-main-blue"><span>FAQ</span> Fix N Flow Plumbing</h2>
            <p class="text-main-blue text-center pt-7 font-semibold">All your plumbing questions answered here</p>
