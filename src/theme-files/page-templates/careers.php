    ...
    <div class="careersBanner max-w-[1874px] mx-auto p-2 xl:p-6">
        <div class="flex flex-wrap -mx-2 gap-y-2">
            ...
            <div class="w-full lg:w-5/12 px-2 order-1 md:order-2">
                <div class="rounded-[20px] md:rounded-[30px] min-h-[272px] bg-light-blue h-full overflow-hidden" style="background:url(<?= $banner['image']['url'] ?>) no-repeat center; background-size: cover">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-wrap -mx-3 items-center py-12 lg:py-24 gap-y-10" data-aos="fade-up">
            ...
            <div class="w-full lg:w-1/2 px-3 order-1 md:order-3 lg:order-2">
                <div class="text-center bg-quaternary rounded-[30px] py-12 px-5 md:p-16 lg:px-5 xl:p-16">
                    <h2 class="text-grey text-3xl md:text-[45px] leading-none font-bold highlight-light-blue"><?= $introduction['heading'] ?></h2>
                    <article class="text-grey leading-relaxed py-11 font-articulat description"><?= $introduction['description'] ?></article>
    ...
    <div class="bg-dark-blue py-20 md:py-28">
        ...
        <div class="container">
            <div class="flex flex-wrap justify-around gap-y-5" data-aos="fade-up">
                <h2 class="w-full lg:w-5/12 text-4xl md:text-5xl xl:text-heading leading-none text-white font-bold text-center highlight-main-blue">
                    <?= $form['hero_heading'] ? $form['hero_heading'] : '' ?>
                </h2>
                <article class="w-full lg:w-5/12 text-white font-articulat text-base leading-loose description text-center lg:text-start">
            ...
            <div class="bg-light-blue rounded-[30px] px-5 py-10 md:p-10 mt-16 md:mt-20" data-aos="zoom-in">
                <div class="flex flex-wrap gap-y-10">
                    <div class="w-full lg:w-1/2">
                        ...
                        <h3 class="text-white text-3xl md:text-[45px] font-semibold py-11 leading-none highlight-main-blue"><?= $form['form_heading'] ? $form['form_heading'] : '' ?></h3>
                        <p class="font-articulat text-white leading-loose"><?= $form['sub_heading'] ? $form['sub_heading'] : '' ?></p>
                    </div>
                    <div class="w-full lg:w-1/2 careersForm">
                        <p class="font-articulat text-white leading-loose">Attach your documents below and we will be in touch</p>
